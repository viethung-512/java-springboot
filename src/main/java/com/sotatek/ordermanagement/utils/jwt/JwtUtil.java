...
public class JwtUtil {
    public static final Map<String, Object> RS256_TOKEN_HEADER = Map.ofEntries(Map.entry("typ", "JWT"), Map.entry("alg", "RS256"));
    private static final String BEARER_PREFIX = "Bearer ";
    private static final String RSA_ALGORITHM = "RSA";

    @NonNull
    public static PublicKey extractRSAPublicKey(@NonNull final String publicKey) throws NoSuchAlgorithmException, InvalidKeySpecException {
        final String extractedPublicKey = extractPublicKey(publicKey);
        final X509EncodedKeySpec encodedKeySpec = new X509EncodedKeySpec(Base64.getDecoder().decode(extractedPublicKey));
    ...
    public static Claims extractAllClaims(
            @NonNull final String jwt, @NonNull final PublicKey publickey) throws InvalidJwtError {
    ...
    @NonNull
    public static String generateAccessToken(@NonNull final Map<String, Object> header,
